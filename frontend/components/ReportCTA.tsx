  ...
  return (
    <section className="print-hide space-y-6 rounded-2xl border border-neutral-200 bg-neutral-50 p-6 sm:p-8">
      ...
      <div className="border-t border-neutral-200 pt-6">
        <h3 className="text-base font-medium text-neutral-900">Заказать deep-аудит</h3>
        <p className="mt-1 text-sm text-neutral-600">
          Расширенный отчёт: 50 запросов, динамика по месяцам, контент-рекомендации.
          Оставь email — пришлём детали.
        </p>
        {submitted ? (
          <p className="mt-4 text-sm text-green-700">Спасибо! Свяжемся в течение суток.</p>
        ) : (
